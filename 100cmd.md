...
- [Dark mode](outros/101-linux-commands-ebook/ebook/en/export/101-linux-commands-ebook-dark.pdf)

- [Light mode](outros/101-linux-commands-ebook/ebook/en/export/101-linux-commands-ebook-light.pdf)
...
| ------- | ---------------- | ------------------------------------------------- |
| [`cd`](outros/101-linux-commands-ebook/ebook/en/content/002-the-cd-command.md)    | `-`              | Navigate to last dir                              |
|         | `~`              | Navigate to home                                  |
|         | `~username`      | Navigate to home of specified user                |
| [`pwd`](outros/101-linux-commands-ebook/ebook/en/content/006-the-pwd-command.md)   |                  | Print working dir                                 |
| [`ls`](outros/101-linux-commands-ebook/ebook/en/content/001-the-ls-command.md)    |                  | Print dir content                                 |
|         | `-l`             | Format as list                                    |
...
| [`mkdir`](outros/101-linux-commands-ebook/ebook/en/content/014-the-mkdir-command.md) | `-p`             | Create dir with parents                           |
| [`cp`](outros/101-linux-commands-ebook/ebook/en/content/031-the-cp-command.md)    | `-r`             | Copy dir                                          |
| [`rmdir`](outros/101-linux-commands-ebook/ebook/en/content/103-the-rmdir-command.md) | `-p`             | Remove dir and empty parents                      |
| [`rm`](outros/101-linux-commands-ebook/ebook/en/content/040-the-rm-command.md)    | `-rf`            | Remove dir recursively, `-f` without confirmation |
| [`mv`](outros/101-linux-commands-ebook/ebook/en/content/032-the-mv-command.md)    |                  | Move recursively                                  |
| [`find`](outros/101-linux-commands-ebook/ebook/en/content/102-the-find-command.md)  | `-iname pattern` | Search dir/file case-insensitive                  |
...
| Command | Options                                      | Description                                |
| ------- | ------------------------------------------ | ------------------------------------------ |
| [`cat`](outros/101-linux-commands-ebook/ebook/en/content/003-the-cat-tac-command.md)   | `file`                                     | Print content                              |
| [`tac`](outros/101-linux-commands-ebook/ebook/en/content/003-the-cat-tac-command.md)   | `file`                                     | Print content inverted                     |
| [`sort`](outros/101-linux-commands-ebook/ebook/en/content/059-the-sort-command.md)  | `file`                                     | Print sorted                               |
|         | `file -r -u`                               | Print sorted descending without dublicates |
| [`head`](outros/101-linux-commands-ebook/ebook/en/content/004-the-head-command.md)  | `-n10 file`                            | Print lines 5-10                           |
| [`tail`](outros/101-linux-commands-ebook/ebook/en/content/005-the-tail-command.md)  | `-f file`                                  | Print new lines automatically              |
| [`cut`](outros/101-linux-commands-ebook/ebook/en/content/098-the-cut-command.md)   | `-f -4,7-10,12,15- file`                   | Print selected fields (tab delimited)      |
...
| [`uniq`](outros/101-linux-commands-ebook/ebook/en/content/074-the-uniq-command.md)  | `file`                                     | Hide consecutive identical lines           |
...
| Command          | Options                          | Description                                              |
| ---------------- | -------------------------------- | -------------------------------------------------------- |
| [`tar`](outros/101-linux-commands-ebook/ebook/en/content/063-the-tar-command.md)            | `cfv archiv.tar file1 file2`     | Create archive / add or overwrite content  |
...
| [`bzip2`](outros/101-linux-commands-ebook/ebook/en/content/069-the-bzip2-command.md) | `file1 file2`                    | Dateien (einzeln) komprimieren                           |
|                  | `-d file1 file2`                 | Compress files (one at a time)                           |
| [`gzip`](outros/101-linux-commands-ebook/ebook/en/content/015-the-gzip-command.md) | `file1 file2`                    | Dateien (einzeln) komprimieren                           |
...
| [`df`](outros/101-linux-commands-ebook/ebook/en/content/010-the-df-command.md)|                -    | Show disk usage                      |
...
|             | `-h`            |                                            |
|             | `-?`            |                                            |
| [`man`](outros/101-linux-commands-ebook/ebook/en/content/024-the-man-command.md)       | `<command>`     | Manual page of command                     |
...
| Command | Options             | Description    |
| ------- | ----------------- | -------------- |
| [`grep`](outros/101-linux-commands-ebook/ebook/en/content/107-the-grep-command.md)  | `pattern file`    | Extended Regex |
...
[`VI/VIM`](outros/101-linux-commands-ebook/ebook/en/content/100-the-vim-command.md)
**Editing**
...
| [`who`](outros/101-linux-commands-ebook/ebook/en/content/017-the-who-command.md)      | 						      | Show logged in users 					|
| [`last`](outros/101-linux-commands-ebook/ebook/en/content/048-the-last-command.md)     | 						      | Show last logins 					|
| `lastb`    | 						      | Show last failed logins 				|
| [`sudo`](outros/101-linux-commands-ebook/ebook/en/content/051-the-sudo-command.md)     | `-u user command` 			      | Execute command with user rights (default is root) 	|
|            | `-i` or` su -` 				      | Shell with root rights 					|
| [`su`](outros/101-linux-commands-ebook/ebook/en/content/044-the-su-command.md)       | 						      | Shell as root (non-login shell) 			|
|            | `-` 					      | Shell as root (login shell) 				|
| 	     | `- user` 				      | Shell as user 						|
| [`useradd`](outros/101-linux-commands-ebook/ebook/en/content/080-the-useradd-command.md)  | `-u 2101 -g primarygroup -c comment username`  | Create user (without `-g`, new group will be created)   |
| [`usermod`](outros/101-linux-commands-ebook/ebook/en/content/082-the-usermod-command.md)  | `-G group1, group2` 			      | Define (overwrite) secondary groups 			|
| 	     | `-ag group, group2` 			      | Add secondary groups 					|
|            | `-l username` 				      | Change username 					|
| 	     | `-L` 					      | Lock Account 						|
| 	     | `-U` 					      | Unlock Account 						|
| 	     | `-s shellpath`  				      | Change shell 						|
| [`userdel`](outros/101-linux-commands-ebook/ebook/en/content/081-the-userdel-command.md)  | `-r username` 				      | Delete user including home and mail spool 		|
| [`passwd`](outros/101-linux-commands-ebook/ebook/en/content/025-the-passwd-command.md)   | `username` 				      | Change password (interactive) 				|
...
| Command   | Options                    | Description                                      |
| --------- | ------------------------ | ------------------------------------------------- |
| [`chmod`](outros/101-linux-commands-ebook/ebook/en/content/106-the-chmod-command.md)   | `-R [uog] dirname`       | Set permissions recursively using binary flags    |
...
| [`chown`](outros/101-linux-commands-ebook/ebook/en/content/101-the-chown-command.md)   | `-R user:group filename` | Change owner (*User* & *Group*) recursively       |
...
[`SSH`](outros/101-linux-commands-ebook/ebook/en/content/089-the-ssh-command.md)
...
**[`Crontab`](outros/101-linux-commands-ebook/ebook/en/content/091-the-crontab-command.md)**
...
[`RPM`](outros/101-linux-commands-ebook/ebook/en/content/075-the-rpm-command.md)
...
[`YUM`](outros/101-linux-commands-ebook/ebook/en/content/053-the-yum-command.md) is configured in `/etc/yum.conf`
